const zh = {
    ...
    exhausted: '已用尽',
    validUntil: '有效至期',
    accountValidity: '账号有效期',
    accountExpireTime: '账号到期',
    accountRemaining: '剩余',
    remainingDayHour: '{day}天{hour}小时',
    remainingHourMinute: '{hour}小时{minute}分钟',
    remainingMinute: '{minute}分钟',
    validityTest: '测试卡（注册后3天）',
    validityMonth: '月卡（注册后1个月）',
    validityQuarter: '季卡（注册后3个月）',
    validityYear: '年卡（注册后1年）',
    expired: '已过期',
    copy: '复制',
    copyCode: '复制验证码',
    codeLabel: '验证码：',
    history: '记录',
    addRegKey: '添加注册码',
    batchAddRegKey: '批量生成注册码',
    batchAdd: '批量生成',
    batchCount: '生成数量',
    perRegKeyUseCount: '每个注册码可用次数',
    regKeyLength: '注册码长度',
    batchRegKeyDesc: '批量生成会自动生成不重复的随机注册码，套餐类型决定用户注册或续费后账号延长多久；测试卡为3天。',
    exportTestRegKey: '导出测试卡注册码',
    exportMonthRegKey: '导出月卡注册码',
    exportQuarterRegKey: '导出季卡注册码',
    exportYearRegKey: '导出年卡注册码',
    exportAllRegKey: '导出全部注册码',
    exportTestRegKeyTitle: '测试卡注册码',
    exportMonthRegKeyTitle: '月卡注册码',
    exportQuarterRegKeyTitle: '季卡注册码',
    exportYearRegKeyTitle: '年卡注册码',
    exportAllRegKeyTitle: '全部注册码',
    exportTestRegKeyFile: '测试卡注册码',
    exportMonthRegKeyFile: '月卡注册码',
    exportQuarterRegKeyFile: '季卡注册码',
    exportYearRegKeyFile: '年卡注册码',
    exportAllRegKeyFile: '全部注册码',
    exportTime: '导出时间',
    exportTotal: '导出数量',
    status: '状态',
    regKey: '注册码',
    ...
    renewTitle: '输入邮箱、密码和新注册码给账号续费',
    renewRegKey: '新注册码',
    renewBtn: '续费',
    accountExpiredQuestion: '账号到期了?',
    renewSwitch: '去续费',
    confirmPwd: '确认密码',
    ...
    emptyValidityMsg: '账号有效套餐不能为空',
    addSuccessMsg: '添加成功',
    batchAddSuccessMsg: '批量生成成功，共生成 {count} 个注册码',
    emptyBatchCountMsg: '生成数量不能为空',
    exportSuccessMsg: '导出成功',
    exportNoDataMsg: '没有可导出的注册码',
