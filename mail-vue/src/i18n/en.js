const en = {
    ...
    accountExpireTime: 'Account Expires',
    accountRemaining: 'remaining',
    remainingDayHour: '{day}d {hour}h',
    remainingHourMinute: '{hour}h {minute}m',
    remainingMinute: '{minute}m',
    validityTest: 'Trial (3 days after signup)',
    validityMonth: 'Monthly (1 month after signup)',
    validityQuarter: 'Quarterly (3 months after signup)',
    validityYear: 'Yearly (1 year after signup)',
    expired: 'Expired',
    copy: 'Copy',
    copyCode: 'Copy Code',
    codeLabel: 'Code: ',
    ...
    batchAddRegKey: 'Batch Generate Invite Codes',
    batchAdd: 'Batch Generate',
    batchCount: 'Quantity',
    perRegKeyUseCount: 'Uses per invite code',
    regKeyLength: 'Invite code length',
    batchRegKeyDesc: 'Batch generation creates unique random invite codes automatically. The plan controls how long the user account is extended after signup or renewal; trial codes are valid for 3 days.',
    exportTestRegKey: 'Export trial codes',
    exportMonthRegKey: 'Export monthly codes',
    exportQuarterRegKey: 'Export quarterly codes',
    exportYearRegKey: 'Export yearly codes',
    exportAllRegKey: 'Export all codes',
    exportTestRegKeyTitle: 'Trial invite codes',
    exportMonthRegKeyTitle: 'Monthly invite codes',
    exportQuarterRegKeyTitle: 'Quarterly invite codes',
    exportYearRegKeyTitle: 'Yearly invite codes',
    exportAllRegKeyTitle: 'All invite codes',
    exportTestRegKeyFile: 'trial-invite-codes',
    exportMonthRegKeyFile: 'monthly-invite-codes',
    exportQuarterRegKeyFile: 'quarterly-invite-codes',
    exportYearRegKeyFile: 'yearly-invite-codes',
    exportAllRegKeyFile: 'all-invite-codes',
    ...
    renewTitle: 'Enter your email, password, and a new invite code to renew',
    renewRegKey: 'New invite code',
    renewBtn: 'Renew',
    accountExpiredQuestion: 'Account expired? \u200B',
    renewSwitch: 'Renew',
    ...
    renewSuccessMsg: 'Renewed successfully. Please sign in again',
    ...
    emptyValidityMsg: 'Account validity plan cannot be empty',
    addSuccessMsg: 'Addition successful',
    batchAddSuccessMsg: 'Batch generated successfully. {count} invite codes created.',
    emptyBatchCountMsg: 'Quantity cannot be empty',
    exportSuccessMsg: 'Exported successfully',
    exportNoDataMsg: 'No invite codes to export',
