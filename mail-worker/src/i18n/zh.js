const zh = {
	...
	accountLimit: '累计添加邮箱数量已达到权限身份限制，删除邮箱不会释放额度',
	...
	regKeyBatchCount: '批量生成数量不能为空',
	regKeyBatchCountLimit: '单次最多批量生成1000个注册码',
	regKeyCodeLengthLimit: '注册码长度必须在6到32位之间',
	regKeyBatchGenerateFail: '批量生成注册码失败，请调大注册码长度后重试',
