const en = {
	...
	regKeyBatchCount: 'Batch quantity cannot be empty',
	regKeyBatchCountLimit: 'You can generate up to 1000 invite codes at a time',
	regKeyCodeLengthLimit: 'Invite code length must be between 6 and 32',
	regKeyBatchGenerateFail: 'Failed to generate invite codes. Please increase the code length and try again',
